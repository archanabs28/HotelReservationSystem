             ...
             <div class="form-group">
                <h3> Breakfast Selected  </h3>
                 ...
                 <fieldset class="row1">
                                    ...
                                    <table  style="width:150%" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                            ...
                                            <td style="color: #000" width="20%" align="left"><%=breakfasttype.get(i)%></td> 
                                         ...
                                         <tr>
                                          ...
                                          <%}%>
                                          <td>&nbsp;</td>
                                              <td tyle="color: #000" width="20%" align="left">Total</td>
                                              <td style="color: #000" width="20%" align="left"><b>$ </b><%=sum%></td>
