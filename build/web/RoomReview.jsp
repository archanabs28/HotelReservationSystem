...
<%
    ...
    List<RoomReservationBean>list=service.getRoomReservationDetails(userName);
                                    ...
                                    <table  style="width:50%" cellspacing="0" cellpadding="0" align="center">
                                        ...
                                        %>
                                          ...
                                          <tr>
                                             ...
                                             <td style="color: #000" width="20%" align="left"><div><%=bean.getRoomNo()%></div></td>
